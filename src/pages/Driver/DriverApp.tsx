...
export const DriverApp = () => {
  ...
  const handleCancelRide = async (rideId) => {
    ...
    try {
      ...
      if (!data) {
        throw new Error(
          "Ride not found or already cancelled, or you do not have permission to cancel this ride"
        );
      }
            ...
            <div className="flex items-center space-x-4">
              ...
              <Dialog open={isPostRideOpen} onOpenChange={setIsPostRideOpen}>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle>
                      {editingRide ? "Edit Ride" : "Post a New Ride"}
                    </DialogTitle>
                    <DialogDescription>
                      {editingRide
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent>
                <div className="text-3xl font-bold">
                  {profile?.role === "driver" && profile?.average_rating
                    ? Number(profile.average_rating).toFixed(1)
                    : "0.0"}
                </div>
                <p className="text-xs text-muted-foreground flex items-center mt-1">
                  <Users className="h-3 w-3 mr-1" />
                  {profile?.role === "driver" ? profile?.total_ratings || 0 : 0} reviews
                </p>
              </CardContent>
            </Card>
          </div>
                  ...
                  <CardContent>
                    {loading ? (
                            ...
                            <div className="flex justify-between items-start mb-3">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {ride.vehicles?.car_model} (
                                  {ride.vehicles?.car_type})
                                </p>
                              </div>
                      ...
                      <div className="text-center py-8 text-muted-foreground">
                        ...
                        <p className="text-sm">
                          Start by posting your first ride
                        </p>
                      </div>
                    )}
                  </CardContent>
