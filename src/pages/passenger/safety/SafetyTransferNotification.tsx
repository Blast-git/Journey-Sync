...
const SafetyTransferNotification: React.FC<SafetyTransferNotificationProps> = ({
  transferRequest,
  onResponse,
  onExpire,
}) => {
  ...
  const handleResponse = async (response: "accepted" | "declined") => {
    ...
    try {
      ...
      toast({
        title:
          response === "accepted" ? "Transfer Accepted" : "Transfer Declined",
        description:
          response === "accepted"
    ...
    <Card className="w-full max-w-2xl mx-auto border-orange-200 bg-orange-50">
      <CardHeader className="pb-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <Badge
            variant={
              transferRequest.priority === "PRIMARY" ? "default" : "secondary"
            }
          >
            {transferRequest.priority === "PRIMARY"
              ? "Priority Transfer"
              : "Safe Transfer Available"}
          </Badge>
        </div>
        ...
        <CardDescription className="text-orange-700">
          We found a more suitable cab that enhances your safety and comfort.
          This transfer is optional.
        </CardDescription>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="font-medium">
                  {transferRequest.targetRide.driverName}
                </span>
            ...
            <div>
              ...
              <p className="font-medium">
                ...
                {transferRequest.targetRide.vehicleColor &&
                  ` (${transferRequest.targetRide.vehicleColor})`}
              </p>
              <p className="text-xs text-gray-500">
                {transferRequest.targetRide.licensePlate}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-medium">
                {transferRequest.targetRide.departureTime}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-medium">
                {transferRequest.targetRide.pickupPoint}
              </p>
            </div>
          </div>
        </div>
...
export default SafetyTransferNotification;
