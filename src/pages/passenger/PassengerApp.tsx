...
import RideSearchBooking from "@/components/Ride Booking/RideSearchBooking";
import ListRides from "@/components/Ride Booking/ListRides";
import RideBooking from "@/components/Ride Booking/rideBooking";
...
import PassengerBookingConfirmation from "@/components/Ride Booking/PassengerBookingConfirmation"; // or wherever you place the component
import { PassengerRoutePreview } from "@/components/maps/passenger/Booking/PassengerRoutePreview";
import BookingTicket from "@/components/Ride Booking/BookingTicket";
      ...
      <TooltipProvider>
        ...
        <div className="min-h-screen bg-background">
          ...
          >
            <ErrorBoundary>
              <Routes>
                {/* Main Passenger Landing Page - Search Form Only */}
                <Route
                ...
                />
                {/* NEW ROUTES - List of search results */}
                <Route
                  path="/list-rides"
                  element={
                    <ProtectedRoute>
                ...
                />
                {/* NEW ROUTES - Individual ride booking */}
                <Route
                  path="/ride-booking/:rideId"
                  element={
                    <ProtectedRoute>
                      <RideBooking />
                    </ProtectedRoute>
